...
<Project Type="Project" LVVersion="20008000">
	<Item Name="我的电脑" Type="My Computer">
		...
		<Item Name="依赖关系" Type="Dependencies">
			...
			<Item Name="Keithley 622x.lvlib" Type="Library" URL="../src/Keithley 622x/Keithley 622x.lvlib"/>
			<Item Name="lvanlys.dll" Type="Document" URL="/&lt;resource&gt;/lvanlys.dll"/>
			<Item Name="MB Ethernet Call Wait on Query.vi" Type="VI" URL="../src/TcpModbus_SlaveServer/MB Ethernet Call Wait on Query.vi"/>
			<Item Name="MB Ethernet Check Client.vi" Type="VI" URL="../src/TcpModbus_SlaveServer/MB Ethernet Check Client.vi"/>
			<Item Name="MB Ethernet Connection Function.ctl" Type="VI" URL="../src/TcpModbus_SlaveServer/MB Ethernet Connection Function.ctl"/>
			<Item Name="MB Ethernet Connection Manager.vi" Type="VI" URL="../src/TcpModbus_SlaveServer/MB Ethernet Connection Manager.vi"/>
			<Item Name="MB Ethernet Is Address Valid.vi" Type="VI" URL="../src/TcpModbus_SlaveServer/MB Ethernet Is Address Valid.vi"/>
			<Item Name="MB Ethernet Receive.vi" Type="VI" URL="../src/TcpModbus_SlaveServer/MB Ethernet Receive.vi"/>
			<Item Name="MB Ethernet RefCount.vi" Type="VI" URL="../src/TcpModbus_SlaveServer/MB Ethernet RefCount.vi"/>
			<Item Name="MB Ethernet Slave Communication.vi" Type="VI" URL="../src/TcpModbus_SlaveServer/MB Ethernet Slave Communication.vi"/>
			<Item Name="MB Ethernet String to Modbus Data Unit.vi" Type="VI" URL="../src/TcpModbus_SlaveServer/MB Ethernet String to Modbus Data Unit.vi"/>
			<Item Name="MB Ethernet Transmit.vi" Type="VI" URL="../src/TcpModbus_SlaveServer/MB Ethernet Transmit.vi"/>
			<Item Name="MB Ethernet Wait on Query.vi" Type="VI" URL="../src/TcpModbus_SlaveServer/MB Ethernet Wait on Query.vi"/>
			<Item Name="MB Globals.vi" Type="VI" URL="../src/TcpModbus_SlaveServer/MB Globals.vi"/>
			<Item Name="MB Modbus Data Unit.ctl" Type="VI" URL="../src/TcpModbus_SlaveServer/MB Modbus Data Unit.ctl"/>
			<Item Name="MB RefCount Function.ctl" Type="VI" URL="../src/TcpModbus_SlaveServer/MB RefCount Function.ctl"/>
			<Item Name="MB Registers Manager.vi" Type="VI" URL="../src/TcpModbus_SlaveServer/MB Registers Manager.vi"/>
			<Item Name="MB Slave Init (poly).vi" Type="VI" URL="../src/TcpModbus_SlaveServer/MB Slave Init (poly).vi"/>
			<Item Name="MB Slave Operations (poly).vi" Type="VI" URL="../src/TcpModbus_SlaveServer/MB Slave Operations (poly).vi"/>
			<Item Name="MB Slave Read All Coils (poly).vi" Type="VI" URL="../src/TcpModbus_SlaveServer/MB Slave Read All Coils (poly).vi"/>
			<Item Name="MB Slave Read All Discrete Inputs (poly).vi" Type="VI" URL="../src/TcpModbus_SlaveServer/MB Slave Read All Discrete Inputs (poly).vi"/>
			<Item Name="MB Slave Read All Holding Registers (poly).vi" Type="VI" URL="../src/TcpModbus_SlaveServer/MB Slave Read All Holding Registers (poly).vi"/>
			<Item Name="MB Slave Read All Input Registers (poly).vi" Type="VI" URL="../src/TcpModbus_SlaveServer/MB Slave Read All Input Registers (poly).vi"/>
			<Item Name="MB Slave Read Coils (poly).vi" Type="VI" URL="../src/TcpModbus_SlaveServer/MB Slave Read Coils (poly).vi"/>
			<Item Name="MB Slave Read Discrete Inputs (poly).vi" Type="VI" URL="../src/TcpModbus_SlaveServer/MB Slave Read Discrete Inputs (poly).vi"/>
			<Item Name="MB Slave Read Holding Registers (poly).vi" Type="VI" URL="../src/TcpModbus_SlaveServer/MB Slave Read Holding Registers (poly).vi"/>
			<Item Name="MB Slave Read Input Registers (poly).vi" Type="VI" URL="../src/TcpModbus_SlaveServer/MB Slave Read Input Registers (poly).vi"/>
			<Item Name="MB Slave Write Coils (poly).vi" Type="VI" URL="../src/TcpModbus_SlaveServer/MB Slave Write Coils (poly).vi"/>
			<Item Name="MB Slave Write Discrete Inputs (poly).vi" Type="VI" URL="../src/TcpModbus_SlaveServer/MB Slave Write Discrete Inputs (poly).vi"/>
			<Item Name="MB Slave Write Holding Registers (poly).vi" Type="VI" URL="../src/TcpModbus_SlaveServer/MB Slave Write Holding Registers (poly).vi"/>
			<Item Name="MB Slave Write Input Registers (poly).vi" Type="VI" URL="../src/TcpModbus_SlaveServer/MB Slave Write Input Registers (poly).vi"/>
			<Item Name="MB Update Registers.vi" Type="VI" URL="../src/TcpModbus_SlaveServer/MB Update Registers.vi"/>
			<Item Name="nilvaiu.dll" Type="Document" URL="nilvaiu.dll">
				<Property Name="NI.PreserveRelativePath" Type="Bool">true</Property>
			</Item>
			<Item Name="PointReactorDll.dll" Type="Document" URL="../src/PointReactorDll.dll"/>
			<Item Name="Sti_Switch.vi" Type="VI" URL="../src/Sti_Switch.vi"/>
		</Item>
...
www.nustarnuclear.com</Property>
			...
			<Item Name="反应性仪测试软件安装包精简" Type="Installer">
				<Property Name="Destination[0].name" Type="Str">核星反应性仪测试软件</Property>
				<Property Name="Destination[0].parent" Type="Str">{3912416A-D2E5-411B-AFEE-B63654D690C0}</Property>
				<Property Name="Destination[0].tag" Type="Str">{2DC7144D-EAB0-4B17-BFD4-EF0492ACAA81}</Property>
				<Property Name="Destination[0].type" Type="Str">userFolder</Property>
				...
				<Property Name="DistPart[1].productID" Type="Str">{84EDD624-82A5-4A41-8D30-CA43D7560540}</Property>
				<Property Name="DistPart[1].productName" Type="Str">NI-DAQmx Runtime 20.1</Property>
				...
				<Property Name="DistPart[3].productID" Type="Str">{0A544682-7390-49DD-8471-7F65403AD302}</Property>
				<Property Name="DistPart[3].productName" Type="Str">NI System Configuration Runtime 20.0.0</Property>
				<Property Name="DistPart[3].upgradeCode" Type="Str">{0E192465-CC28-4C84-BE81-710B71C595A3}</Property>
				<Property Name="DistPart[4].flavorID" Type="Str">_full_</Property>
				<Property Name="DistPart[4].productID" Type="Str">{2EB63900-C920-494E-9F7B-56E6B2DCBEE9}</Property>
				<Property Name="DistPart[4].productName" Type="Str">NI LabWindows/CVI Shared Runtime 2019</Property>
				<Property Name="DistPart[4].SoftDep[0].exclude" Type="Bool">true</Property>
				<Property Name="DistPart[4].SoftDep[0].productName" Type="Str">Analysis Support</Property>
				<Property Name="DistPart[4].SoftDep[0].upgradeCode" Type="Str">{86208B51-159E-4F6F-9C62-0D5EFC9324D8}</Property>
				<Property Name="DistPart[4].SoftDep[1].exclude" Type="Bool">true</Property>
				<Property Name="DistPart[4].SoftDep[1].productName" Type="Str">.NET Support</Property>
				<Property Name="DistPart[4].SoftDep[1].upgradeCode" Type="Str">{0DDB211A-941B-4125-9518-E81E10409F2E}</Property>
				<Property Name="DistPart[4].SoftDep[2].exclude" Type="Bool">true</Property>
				<Property Name="DistPart[4].SoftDep[2].productName" Type="Str">Network Variable Support</Property>
				<Property Name="DistPart[4].SoftDep[2].upgradeCode" Type="Str">{15CE39FE-1354-484D-B8CA-459077449FB3}</Property>
				<Property Name="DistPart[4].SoftDep[3].exclude" Type="Bool">true</Property>
				<Property Name="DistPart[4].SoftDep[3].productName" Type="Str">Network Streams Support</Property>
				<Property Name="DistPart[4].SoftDep[3].upgradeCode" Type="Str">{40A5AD7F-4BAF-4A5C-8B56-426B84F75C05}</Property>
				<Property Name="DistPart[4].SoftDep[4].exclude" Type="Bool">true</Property>
				<Property Name="DistPart[4].SoftDep[4].productName" Type="Str">TDMS Support</Property>
				<Property Name="DistPart[4].SoftDep[4].upgradeCode" Type="Str">{5A8AF88D-486D-4E30-A7A5-8D8A039BBEBF}</Property>
				<Property Name="DistPart[4].SoftDepCount" Type="Int">5</Property>
				<Property Name="DistPart[4].upgradeCode" Type="Str">{80D3D303-75B9-4607-9312-E5FC68E5BFD2}</Property>
				<Property Name="DistPartCount" Type="Int">5</Property>
				<Property Name="INST_buildLocation" Type="Path">/E/反应性仪测试软件安装包精简版</Property>
				<Property Name="INST_buildSpecName" Type="Str">反应性仪测试软件安装包精简</Property>
				<Property Name="INST_defaultDir" Type="Str">{2DC7144D-EAB0-4B17-BFD4-EF0492ACAA81}</Property>
				<Property Name="INST_installerName" Type="Str">setup.exe</Property>
				<Property Name="INST_language" Type="Int">2052</Property>
				<Property Name="INST_productName" Type="Str">反应性仪测试软件</Property>
				...
				<Property Name="MSI_arpPhone" Type="Str">021-60901055</Property>
				<Property Name="MSI_arpURL" Type="Str">www.nustarnuclear.com</Property>
				<Property Name="MSI_distID" Type="Str">{07E74233-3ED1-4D92-9616-828513D9C198}</Property>
				<Property Name="MSI_osCheck" Type="Int">0</Property>
				<Property Name="MSI_upgradeCode" Type="Str">{1B95F815-5646-48A9-901A-5703E935FEBF}</Property>
				<Property Name="MSI_windowMessage" Type="Str">核星反应性仪测试系统
